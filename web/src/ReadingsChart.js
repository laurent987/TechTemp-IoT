...
function pivotReadings(rawReadings, selectedRooms) {
...
export default function ReadingsChart({ data, loading, error, selectedRooms, startDate }) {
  ...
  const chartData = pivotReadings(data, selectedRooms);
          ...
          <Box position="relative" minH={400}>
            ...
            {loading && (
              ...
              >
                ...
                <Text ml={3}>Chargement des données...</Text>
              </Flex>
            )}
